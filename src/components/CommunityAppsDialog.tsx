      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-left">
            10kb.co builds technical solutions — websites, apps, automations, integrations and
            dashboards. Alongside our client work, we build free community apps like this one.
          </DialogDescription>
        </DialogHeader>
